...
use crate::models::offer_ranking::{
    ...
    RankingWeights, UserPreferences, UserActivity,
    SpendRange, CashbackType, NotificationPreferences,
};
use crate::auth::Claims;
use crate::shared_models::deal::Deal;
...
async fn update_ranking_weights(
    Extension(_pool): Extension<PgPool>,
    Extension(_claims): Extension<Claims>,
    Json(_weights): Json<RankingWeights>,
) -> Result<StatusCode, StatusCode> {
